...
texte_regles = tk.Text(frame_texte_regles, height = 50, width = 60)
...
for row in range(10):
    for col in range(4):
        button = tk.Button(frame_grille_indices, bg="lightgoldenrodyellow", text="",state="disabled",height= 5, width=5)
        button.grid(row=row, column=col,padx=1, pady=1)
