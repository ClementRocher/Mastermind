...
dictionnaire_couleurs = {0 : "Noir", 1 : "Blanc", 2 : "Bleu", 3 : "Jaune", 4 : "Rouge", 5 : "Vert", 6 : "Violet", 7 : "Vide"}
...
def input_joueur():
    essai=0
    essai = int(input("Choisissez une couleur. 1 : Blanc | 2 : Bleu | 3 : Jaune | 4 : Rouge | 5 : Vert | 6 : Violet :  "))
    if essai in [1,2,3,4,5,6]:
        print(essai)
        return essai
    else:
        print("Veuillez entrer une valeur entre 1 et 6 inclus")
        input_joueur()
